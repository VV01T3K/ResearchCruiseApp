...
function FormTemplate(props: FormTemplateProps) {
  ...
  const _getFormA = () =>
    getFormA(cruiseApplication?.id ?? cruiseApplicationId).then((response) => response?.data)
  const _getFormB = () =>
    getFormB(cruiseApplication?.id ?? cruiseApplicationId).then((response) => response?.data)
  const _getFormC = () =>
    getFormC(cruiseApplication?.id ?? cruiseApplicationId).then((response) => response?.data)

  const _getFormForSupervisor = () =>
    getFormForSupervisor(cruiseApplicationId, supervisorCode).then((response) => response?.data)

  const _getFormAInitValues = () => getFormAInitValues().then((response) => response?.data)

  const _getFormBInitValues = () => getFormBInitValues().then((response) => response?.data)

  const _getFormCInitValues = () => getFormCInitValues().then((response) => response?.data)
  ...
  const [formInitValues, setFormInitValues] = useState<FormAInitValues | undefined>(undefined)
