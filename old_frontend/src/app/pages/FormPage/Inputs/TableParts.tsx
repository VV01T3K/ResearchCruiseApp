...
export const CreateRow = () => {
  ...
  return (selectedOption: SelectSingleValue) => {
    const newValue = [...fieldContext!.value, { ...(selectedOption!.value as Array<any>) }]
...
export const BottomMenu = (props: {
  ...
  return (
    <div
      className={
        props.className +
        (formContext!.readOnly ? " table-field-bottom-menu-readonly" : " table-field-bottom-menu")
      }
    >
      {props.children}
    </div>
...
export const RemoveRowButton = () => {
  ...
  return (
    <>
      {!readOnly && (
        <div
          className={"btn-danger btn rounded align-items-center justify-content-center d-flex p-2"}
          onClick={removeRow}
        >
