...
export const publicationCategories = ["subject", "postscript"]

export const publicationCategoriesPL = ["Temat", "Dopisek"]

export const publicationOptions = publicationCategoriesPL.map((taskLabel, index) => ({
  label: taskLabel,
  value: publicationDefaultValues[index],
}))
