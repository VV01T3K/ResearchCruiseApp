...
public static class EvaluationConstants
{
    ...
    public const int PointsForMasterThesisResearchTask = 50;
    public const int PointsForDoctoralThesisResearchTask = 100;
    public const int PointsForProjectPreparationWithoutFinancing = 100;
    public const int PointsForProjectPreparationWithFinancing = 150;
    public const int PointsPerDivisionForDomesticProject = 50;
    public const int DomesticProjectDivision = 100_000; // PLN
    public const int PointsPerDivisionForForeignProject = 80;
