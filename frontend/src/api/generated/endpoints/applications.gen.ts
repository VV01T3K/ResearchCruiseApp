...
export const getRefillApplicationFormCMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof refillApplicationFormC>>, TError,{applicationId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof refillApplicationFormC>>, TError,{applicationId: string}, TContext> => {

const mutationKey = ['refillApplicationFormC'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof refillApplicationFormC>>, {applicationId: string}> = (props) => {
          const {applicationId} = props ?? {};

          return  refillApplicationFormC(applicationId,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RefillApplicationFormCMutationResult = NonNullable<Awaited<ReturnType<typeof refillApplicationFormC>>>

    export type RefillApplicationFormCMutationError = ProblemDetails

    /**
 * @summary Return Form C to editable state.
 */
export const useRefillApplicationFormC = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof refillApplicationFormC>>, TError,{applicationId: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof refillApplicationFormC>>,
        TError,
        {applicationId: string},
        TContext
      > => {
      return useMutation(getRefillApplicationFormCMutationOptions(options), queryClient);
    }
