...
export const getExportCruisesQueryKey = (params?: ExportCruisesParams,) => {
    return [
    `/v2/cruises/export`, ...(params ? [params] : [])
    ] as const;
    }


export const getExportCruisesSuspenseQueryOptions = <TData = Awaited<ReturnType<typeof exportCruises>>, TError = ProblemDetails>(params: ExportCruisesParams, options?: { query?:Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof exportCruises>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getExportCruisesQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof exportCruises>>> = ({ signal }) => exportCruises(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseSuspenseQueryOptions<Awaited<ReturnType<typeof exportCruises>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type ExportCruisesSuspenseQueryResult = NonNullable<Awaited<ReturnType<typeof exportCruises>>>
export type ExportCruisesSuspenseQueryError = ProblemDetails


export function useExportCruisesSuspense<TData = Awaited<ReturnType<typeof exportCruises>>, TError = ProblemDetails>(
 params: ExportCruisesParams, options: { query:Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof exportCruises>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
 , queryClient?: QueryClient
  ):  UseSuspenseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useExportCruisesSuspense<TData = Awaited<ReturnType<typeof exportCruises>>, TError = ProblemDetails>(
 params: ExportCruisesParams, options?: { query?:Partial<UseSuspenseQueryOptions<Awaited<ReturnType<typeof exportCruises>>, TError, TData>>, request?: SecondParameter<typeof customFetch>}
...
export function useExportCruisesSuspense<TData = Awaited<ReturnType<typeof exportCruises>>, TError = ProblemDetails>(
 ...
 , queryClient?: QueryClient
  ...
  const queryOptions = getExportCruisesSuspenseQueryOptions(params,options)
