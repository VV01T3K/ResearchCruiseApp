...
export const ResearchEquipmentDto = zod.strictObject({
  name: zod.string().min(researchEquipmentDtoNameMin).max(researchEquipmentDtoNameMax).optional(),
  insuranceStartDate: zod
    .string()
    .min(researchEquipmentDtoInsuranceStartDateMin)
    .max(researchEquipmentDtoInsuranceStartDateMax)
    .nullish(),
  insuranceEndDate: zod
    .string()
    .min(researchEquipmentDtoInsuranceEndDateMin)
    .max(researchEquipmentDtoInsuranceEndDateMax)
    .nullish(),
