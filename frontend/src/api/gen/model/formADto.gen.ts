...
export const FormADto = zod.object({
  ...
  "description": zod.string().min(formADtoPermissionsItemDescriptionMin).max(formADtoPermissionsItemDescriptionMax).nullish(),
  "executive": zod.string().min(formADtoPermissionsItemExecutiveMin).max(formADtoPermissionsItemExecutiveMax).nullish(),
  "scan": zod.union([zod.null(),zod.object({
  "name": zod.string().min(formADtoPermissionsItemScanTwoNameMin).max(formADtoPermissionsItemScanTwoNameMax).optional(),
  "content": zod.string().optional()
})]).optional()
})).optional(),
  "researchAreaDescriptions": zod.array(zod.object({
  "areaId": zod.uuid().nullish(),
  "differentName": zod.string().min(formADtoResearchAreaDescriptionsItemDifferentNameMin).max(formADtoResearchAreaDescriptionsItemDifferentNameMax).nullish(),
  "info": zod.string().min(formADtoResearchAreaDescriptionsItemInfoMin).max(formADtoResearchAreaDescriptionsItemInfoMax).optional()
})).optional(),
  ...
  "name": zod.string().min(formADtoContractsItemScansItemNameMin).max(formADtoContractsItemScansItemNameMax).optional(),
  "content": zod.string().optional()
})).optional()
})).optional(),
  "ugTeams": zod.array(zod.object({
  "ugUnitId": zod.uuid().optional(),
  "noOfEmployees": zod.string().min(formADtoUgTeamsItemNoOfEmployeesMin).max(formADtoUgTeamsItemNoOfEmployeesMax).optional(),
  "noOfStudents": zod.string().min(formADtoUgTeamsItemNoOfStudentsMin).max(formADtoUgTeamsItemNoOfStudentsMax).optional()
})).optional(),
