import { DidacticsResearchTaskThumbnail } from '@/components/applications/common/research-task-thumbnails/DidacticsResearchTaskThumbnail';
import { OtherResearchTaskThumbnail } from '@/components/applications/common/research-task-thumbnails/OtherResearchTaskThumbnail';
import { OwnResearchTaskThumbnail } from '@/components/applications/common/research-task-thumbnails/OwnResearchTaskThumbnail';
import { ProjectPreparationResearchTaskThumbnail } from '@/components/applications/common/research-task-thumbnails/ProjectPreparationResearchTaskThumbnail';
import { ProjectResearchTaskThumbnail } from '@/components/applications/common/research-task-thumbnails/ProjectResearchTaskThumbnail';
import { ThesisResearchTaskThumbnail } from '@/components/applications/common/research-task-thumbnails/ThesisResearchTaskThumbnail';
