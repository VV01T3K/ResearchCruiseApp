...
import { AppTableClearFiltersButton } from '@/components/table/common/AppTableClearFiltersButton';
import { AppTableFilterIcon } from '@/components/table/common/AppTableFilterIcon';
import { AppTableFilterList } from '@/components/table/common/AppTableFilterList';
import { AppTableSortingToggle } from '@/components/table/common/AppTableSortingToggle';
import { getCapabilities } from '@/components/table/common/utils';
import { useOutsideClickDetection } from '@/hooks/OutsideClickDetectionHook';
