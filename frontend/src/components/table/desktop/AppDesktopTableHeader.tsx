...
import { AppTableSortingIcon } from '@/components/table/common/AppTableSortingIcons';
import { getCapabilities } from '@/components/table/common/utils';
import { AppDesktopTableHeaderDropdown } from '@/components/table/desktop/AppDesktopTableHeaderDropdown';
