...
function FieldSet({ className, ...props }: React.ComponentProps<'fieldset'>) {
  return <fieldset data-slot="field-set" className={cn('cn-field-set flex flex-col', className)} {...props} />;
}
...
function FieldLegend({
  ...
  return (
    <legend data-slot="field-legend" data-variant={variant} className={cn('cn-field-legend', className)} {...props} />
  );
}
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="mt-1 flex list-disc flex-col gap-1 pl-1 text-sm text-danger" data-error="true">
  ...
  return (
    <div
      ...
      className={cn('cn-field-error font-normal text-danger', className)}
      {...props}
    >
      {content}
    </div>
