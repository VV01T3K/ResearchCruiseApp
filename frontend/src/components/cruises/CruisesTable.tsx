...
import { CruiseApplicationShortInfoDto, ApplicationCruiseDto } from '@/api/dto/cruises/CruiseDto';
...
type Props = {
  ...
  deleteCruise: (cruise: ApplicationCruiseDto) => void;
  buttons: React.ReactNode[];
};
export function CruisesTable({ cruises, deleteCruise, buttons }: Props) {
  const columns: ColumnDef<ApplicationCruiseDto>[] = [
    {
      header: 'Numer',
      id: 'number',
...
type ActionsCellProps = {
  ...
  deleteCruise: (ApplicationCruiseDto: ApplicationCruiseDto) => void;
};
