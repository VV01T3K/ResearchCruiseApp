...
export const ApplicationsSection = withForm({
  defaultValues: cruiseFormDefaultValues,
  props: {} as { cruiseApplications: CruiseApplicationCandidate[]; isReadonly: boolean },
  render: function Render({ form, cruiseApplications, isReadonly }) {
