      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
        ...
        <div className="space-y-8">
          ...
          <CompanyInfoCard icon={<GlobeAmericasIcon />} title="Strona WWW">
            <AppLink to="office.oceanograf@ug.edu.pl">office.oceanograf@ug.edu.pl</AppLink>
          </CompanyInfoCard>
          <CompanyInfoCard icon={<EnvelopeFillIcon />} title="Email">
            <AppLink to="mail:office.oceanograf@ug.edu.pl">office.oceanograf@ug.edu.pl</AppLink>
          </CompanyInfoCard>
        </div>
      </div>
    </AppPage>
