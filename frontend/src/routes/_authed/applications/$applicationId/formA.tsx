...
import { FormView } from '@/routes/_authed/applications/$applicationId/-components/formA/FormView';
import {
  FORM_A_FIELD_TO_SECTION,
  getFormAValidationSchema,
} from '@/routes/_authed/applications/$applicationId/-schemas/formA.schema';
...
export const Route = createFileRoute('/_authed/applications/$applicationId/formA')({
  component: FormAPage,
