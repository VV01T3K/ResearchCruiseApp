...
import { DidacticsResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/formA/research-task-details/DidacticsResearchTaskDetails';
import { OtherResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/formA/research-task-details/OtherResearchTaskDetails';
import { OwnResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/formA/research-task-details/OwnResearchTaskDetails';
import { ProjectPreparationResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/formA/research-task-details/ProjectPreparationResearchTaskDetails';
import { ProjectResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/formA/research-task-details/ProjectResearchTaskDetails';
import { ThesisResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/formA/research-task-details/ThesisResearchTaskDetails';
