import { DidacticsResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/research-task-display/readonly/DidacticsResearchTaskDetails';
import { OtherResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/research-task-display/readonly/OtherResearchTaskDetails';
import { OwnResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/research-task-display/readonly/OwnResearchTaskDetails';
import { ProjectPreparationResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/research-task-display/readonly/ProjectPreparationResearchTaskDetails';
import { ProjectResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/research-task-display/readonly/ProjectResearchTaskDetails';
import { ThesisResearchTaskDetails } from '@/routes/_authed/applications/$applicationId/-components/research-task-display/readonly/ThesisResearchTaskDetails';
import {
