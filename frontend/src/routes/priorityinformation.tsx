      ...
      <div className="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-clip-border">
        <table className="w-full text-left table-auto">
          ...
          <tbody>
            ...
            <Row>
              <Cell>Przygotowanie do projektu naukowego lub badawczo-rozwojowego</Cell>
              <Cell>
            ...
            <Row>
              ...
              <Cell>50 punktów za każde pełne 100 000 przyznanego dla UG finansowania</Cell>
            </Row>
            <Row>
              <Cell>2) zagraniczne (np. ERC, programy ramowe UE, fundusze norweskie)</Cell>
              <Cell>80 punktów za każde pełne 100 000 przyznanego dla UG finansowania</Cell>
            </Row>
            <Row>
            ...
            <Row>
              <Cell>Dydaktyka</Cell>
              <Cell>Najwyższy priorytet („na sztywno” ustalone konkretne przedziały czasowe w roku)</Cell>
            </Row>
            <Row>
              <Cell>Realizacja własnego zadania badawczego, ukierunkowanego na powstanie publikacji naukowej</Cell>
              <Cell>
            ...
            <Row>
              <Cell>Uczestnictwo osób z 3 lub więcej jednostek organizacyjnych UG</Cell>
              <Cell>100 punktów</Cell>
            </Row>
            <Row>
            ...
            <Row>
              <Cell>Uczestnictwo osób jedynie z 1 jednostki organizacyjnej </Cell>
              <Cell>-</Cell>
            </Row>
            <Row>
              <Cell colSpan={2} className="bg-slate-300 font-semibold">
            ...
            <Row>
              ...
              <Cell>0,5 x suma liczby punktów ministerialnych za wszystkie publikacje</Cell>
            </Row>
            <Row>
              <Cell>
              ...
              <Cell>suma liczby punktów ministerialnych za wszystkie publikacje</Cell>
            </Row>
            <Row>
              <Cell colSpan={2} className="bg-slate-300 font-semibold">
                7. Efekty rejsu:
            ...
            <Row>
              <Cell>Powstanie prac(y) dyplomowa(wych) (licencjackie lub magisterskie)</Cell>
              <Cell>
            ...
            <Row>
              <Cell>Realizacja projektu naukowego lub badawczo-rozwojowego</Cell>
              <Cell>
            ...
            <Row>
              <Cell>Do realizacji własnego zadania badawczego, ukierunkowanego na powstanie publikacji naukowej</Cell>
              <Cell>
            ...
            <Row>
              <Cell>Inne…. (opcja do wpisania innego efektu, np. testowanie nowych technologii, urządzeń itp.)</Cell>
              <Cell>Do indywidualnego rozpatrzenia</Cell>
            </Row>
            <Row>
              <Cell>Uwaga:</Cell>
