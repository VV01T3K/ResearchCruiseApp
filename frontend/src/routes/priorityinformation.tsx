...
function RouteComponent() {
  ...
  return (
    <div className="p-4 w-full min-h-screen backdrop-blur-md relative">
      <div className="max-w-screen-2xl mx-auto px-4 py-16 bg-gray-50 rounded-xl">
        ...
        <div className="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-clip-border">
          <table className="w-full text-left table-auto">
            ...
            <tbody>
              ...
              <Row>
                <Cell>
                  2) zagraniczne (np. ERC, programy ramowe UE, fundusze
                  norweskie)
                </Cell>
                <Cell>
              ...
              <Row>
                ...
                <Cell>
                  ...
                  wpisane, że badania będą prowadzone na r/v Oceanograf i w
                  jakim wymiarze czasowym.
                </Cell>
              </Row>
              <Row>
                <Cell colSpan={2} className="bg-slate-300 font-semibold">
              ...
              <Row>
                ...
                <Cell>
                  ...
                  odpowiednie warunki pogodowe), te „wolne” dni rejsowe z
                  powrotem trafiają do puli do rozdysponowania i mają prawo
                  ubiegać się o te dni w pierwszej kolejności Kierownicy Naukowi
                  rejsów, którzy to ze względu na uzyskany niski wynik w
                  priorytetyzacji nie otrzymali możliwości odbycia pierwotnie
                  zgłaszanego w formularzu A rejsu.
                </Cell>
              </Row>
              <Row>
                <Cell>Dydaktyka</Cell>
                <Cell>
                  Najwyższy priorytet („na sztywno” ustalone konkretne
                  przedziały czasowe w roku)
                </Cell>
              </Row>
              <Row>
                <Cell>
                ...
                <Cell>
                  100 punktów UWAGA: Zgłaszanie rejsu w ramach tego zadania
                  wymaga przedstawienia krótkiego (1 strona A4) opisu zadania
                  badawczego, uwzględniającego cel i założenia, metody, ramy
                  czasowe oraz łączną liczbę dni rejsowych przewidzianą na pełną
                  realizację zadania (zakończoną napisaniem publikacji naukowej
                  do czasopisma z listy JCR). Obowiązkowo należy również podać
                  roboczy tytuł, czasopismo (liczba punktów ministerialnych)
                  oraz rok złożenia planowanej publikacji naukowej.
                </Cell>
              </Row>
              <Row>
                <Cell>Inne</Cell>
              ...
              <Row>
                <Cell>
                  ...
                  nich: autorów, rok wydania, tytuł, nazwę czasopisma i nr, DOI
                  i liczbę punktów ministerialnych).
                </Cell>
                <Cell>
              ...
              <Row>
                <Cell>
                  B) Publikacje z listy powyżej oraz inne niezwiązane
                  tematycznie z zadaniami do realizacji na planowanym rejsie,
                  autorstwa zespołu zaangażowanego w realizację rejsu, ALE
                  zawierające dopisek w treści publikacji (w wersji polskiej lub
                  w innym języku), że „badania w ramach niniejszej publikacji
                  były prowadzone z pokładu RV Oceanograf” (należy podać
                  publikacje, wpisując dla każdej z nich: autorów, rok wydania,
                  tytuł, nazwę czasopisma i nr, DOI i liczbę punktów
                  ministerialnych).
                </Cell>
                <Cell>
              ...
              <Row>
                ...
                <Cell>
                  ...
                  warunkiem, że Kierownik Naukowy zgłaszanego rejsu był
                  promotorem tych prac.
                </Cell>
              </Row>
              <Row>
                <Cell>Powstanie pracy doktorskiej</Cell>
                <Cell>
                  200 punktów – praca doktorska UWAGA: Powstałe i obronione
                  prace muszą zawierać dopisek, że badania były realizowane
                  (próbki były pobierane) z pokładu R/V Oceanograf. Punkty
                  uwzględnianie w priorytetyzacji pod warunkiem, że Kierownik
                  Naukowy zgłaszanego rejsu był promotorem tej pracy LUB autorem
                  tej pracy i jednocześnie pracownikiem UG.
                </Cell>
              </Row>
              <Row>
                <Cell>
                ...
                <Cell>
                  100 punktów, jeżeli w ramach zrealizowanego pod to zadanie
                  rejsu powstała publikacja naukowa za co najmniej 100 punktów
              ...
              <Row>
                ...
                <Cell>
                  ...
                  liczone dodatkowo względem punktów uzyskiwanych w ramach
                  punktu 6 (Historia publikacji) i wskazują one na „efektywność
              ...
              <Row>
                <Cell>
                  Jeżeli dane zadanie w ramach realizacji którego odbywa się
                  rejs zostało zgłoszone we wniosku SPUB
                </Cell>
              ...
              <Row>
                <Cell colSpan={2}>
                  ...
                  uzyskany niski wynik w priorytetyzacji nie otrzymali
                  możliwości odbycia pierwotnie zgłaszanego w formularzu A
                  rejsu.
                </Cell>
              </Row>
              <Row>
              ...
              <Row>
                <Cell colSpan={2}>
                  ...
                  naukowo-badawczy jest rzeczywiście realizowany w danym
                  momencie (ramy czasowe) i we wniosek projektowy zostało
                  wpisane, że badania będą realizowane z pokładu r/v Oceanograf,
                  w Biurze Armatora należy przedstawić odpowiednie dokumenty
                  (wniosek projektowy, decyzja o finansowaniu)
                </Cell>
              </Row>
              <Row>
                <Cell colSpan={2}>
                  ...
                  uwzględniający cel i założenia, metody, ramy czasowe oraz
                  łączną liczbę dni rejsowych przewidzianą na pełną realizację
                  zadania (zakończoną napisaniem publikacji naukowej do
                  czasopisma z listy JCR). Obowiązkowo należy również podać
                  roboczy tytuł, czasopismo (liczba punktów ministerialnych)
                  oraz rok złożenia planowanej publikacji naukowej. DOSTOSOWAĆ
                  DO NOWYCH WARUNKÓW
                </Cell>
              </Row>
            </tbody>
