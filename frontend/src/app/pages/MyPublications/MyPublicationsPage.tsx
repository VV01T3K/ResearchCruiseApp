...
const deletePublication = (publication: PublicationData) => Api.delete('/api/CruiseApplications/ownPublications/' + publication.Id);
const getPublications = () => Api.get('/api/CruiseApplications/ownPublications').then(response => {
...
function MyPublicationsPage() {
    ...
    const {Render} = FieldTableWrapper(colTitle, mdColWidths, mdColTitles, managePublicationsPageTableContent, null, emptyText, publicationList, true)
