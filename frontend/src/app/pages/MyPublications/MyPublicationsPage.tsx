  ...
  return (
    <div className='btn-group-vertical'>
      <div
        ...
        onClick={() =>
          deletePublication(publication).then(() =>
...
const deleteAllPublications = () =>
  Api.delete('/api/CruiseApplications/ownPublications/');
