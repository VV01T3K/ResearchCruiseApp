...
export const SamplesSection = () => SectionWrapper(
    {
        shortTitle: 'Próbki',
        longTitle: 'Rodzaj danych, próbek, materiału badawczego zebranego podczas rejsu, przeprowadzone podczas rejsu analizy',
