...
export const FormDateFieldDayAndHour = (props: {
  className?: string
  minDate?: Date
  maxDate?: Date
}) => {
...
export const BoolField = () => {
  ...
  return (
    <div className={"d-flex flex-row w-100"}>
      <button disabled className={" field-common col-6 " + (cellValue ? " btn btn-primary" : "")}>
        Tak
      </button>
      <button disabled className={"field-common col-6 " + (!cellValue ? " btn btn-primary" : "")}>
        Nie
...
export const FormSelectField = (props: { className?: string; options?: SelectOptions }) => {
  ...
  return (
    <SelectWrapper
      value={props.options!.find((option) => (option as SelectSingleValue)!.value == cellValue)}
