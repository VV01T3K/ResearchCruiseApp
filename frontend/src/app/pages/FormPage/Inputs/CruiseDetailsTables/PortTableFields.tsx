  ...
  return (
    <KeyContext.Provider value={"startTime"}>
      <div className={"task-field-input"}>
        <label className={"table-field-input-label"}>Wejście</label>
...
export const ExitDateField = () => {
  ...
  return (
    <KeyContext.Provider value={"endTime"}>
      <div className={"task-field-input"}>
        <label className={"table-field-input-label"}>Wyjście</label>
        <FDateFieldDayAndHour
          className={"w-100"}
          minDate={cruise?.startDate}
          maxDate={cruise?.endDate}
...
export const NameField = () => {
  return (
    <KeyContext.Provider value={"name"}>
      <div className={"task-field-input"}>
        <label className={"table-field-input-label"}>Nazwa portu</label>
        <FTextField />
      </div>
    </KeyContext.Provider>
  )
