...
export const CategoryPicker = () => {
  const publicationCategoryOptions = publicationCategories.map((category, index) => ({
...
export const YearField = () => {
  return (
    <KeyContext.Provider value={"year"}>
      <div className={"task-field-input"}>
        <label className={"table-field-input-label"}>Rok wydania</label>
        <FDateFieldOnlyYear />
      </div>
    </KeyContext.Provider>
  )
...
export const MinisterialPointsField = () => {
  return (
    <KeyContext.Provider value={"ministerialPoints"}>
      <div className={"task-field-input"}>
        <label className={"table-field-input-label"}>Punkty ministerialne</label>
        <FIntField />
      </div>
    </KeyContext.Provider>
  )
