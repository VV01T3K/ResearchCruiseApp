                            ...
                            validate: {
                                noEmptyRowFields: (value: TechnicalElements[]) => {
                                    for (const row of value) {
                                        if (row.bowStarboard || row.aftStarboard || row.aftPortSide || row.mainCrane || row.bomSTBS || row.bomPS || row.cableRope35kN || row.cableRope5kN || row.mainGantry || row.STBSAuxiliaryGate || row.STBSTrawlElevator || row.PSTrawlElevator || row.workboat || row.observatory) {
                                            return false;
                                        }
                                    }
                                    return false;
                                            ...
                                            <div className="table-striped w-100 bg-primary text-white">
                                                ...
                                                <div className={"w-100 d-flex flex-row border flex-wrap p-3"}>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            className={"col-4 border h-100 d-xl-flex justify-content-center align-items-center "}>Żurawiki
                                                            hydrograficzne
                                                        </div>
                                                        <div
                                                            className={"col-8 d-flex flex-row flex-wrap d-xl-flex justify-content-center align-items-center"}>
                                                            <div
                                                                className={"col-6 border d-xl-flex justify-content-center align-items-center"}>dziobowy
                                                                prawa burta
                                                            </div>
                                                            ...
                                                            <div
                                                                className={"col-6 border d-xl-flex justify-content-center align-items-center"}>rufowy
                                                                prawa burta
                                                            </div>
                                                            <div className={"col-6 border"}>
                                                                <input type={"checkbox"}
                                                    ...
                                                    <div
                                                        className={"col-12 d-flex flex-row align-items-center justify-content-center bg-secondary"}>
                                                        <div
                                                            className={"col-8  border d-xl-flex justify-content-center align-items-center"}>Dźwig
                                                            główny
                                                        </div>
                                                    ...
                                                    <div
                                                        className={"col-12 d-flex flex-row align-items-center justify-content-center bg-secondary"}>
                                                        <div
                                                            className={"col-8  border d-xl-flex justify-content-center align-items-center"}>Bom
                                                            STBS (prawa burta)
                                                        </div>
                                                        <div className={"col-4  border"}>
                                                            <input type={"checkbox"}
                                                    ...
                                                    <div
                                                        className={"col-12 d-flex flex-row align-items-center justify-content-center bg-secondary"}>
                                                        <div
                                                            className={"col-8  border d-xl-flex justify-content-center align-items-center"}>Kablolina
                                                            35 kN
                                                        </div>
                                                        <div className={"col-4  border"}>
                                                            <input type={"checkbox"}
                                                    ...
                                                    <div
                                                        className={"col-12 d-flex flex-row align-items-center justify-content-center bg-secondary"}>
                                                        <div
                                                            className={"col-8  border d-xl-flex justify-content-center align-items-center"}>Bramownica
                                                            główna (rufowa)
                                                        </div>
                                                        <div className={"col-4  border"}>
                                                            <input type={"checkbox"}
                                                    ...
                                                    <div
                                                        className={"col-12 d-flex flex-row align-items-center justify-content-center bg-secondary"}>
                                                        <div
                                                            className={"col-8  border d-xl-flex justify-content-center align-items-center"}>Winda
                                                    ...
                                                    <div
                                                        className={"col-12 d-flex flex-row align-items-center justify-content-center bg-secondary"}>
                                                        <div
                                                            className={"col-8  border d-xl-flex justify-content-center align-items-center"}>Łódź
                                                            robocza
                                                        </div>
                                                        <div className={"col-4  border"}>
                                                            <input type={"checkbox"}
                                                    ...
                                                    <div
                                                        className={"col-12 d-flex flex-row align-items-center justify-content-center bg-secondary"}>
                                                        <div
                                                            className={"col-8  border d-xl-flex justify-content-center align-items-center"}>Obserwatorium
                                                            (bocianie gniazdo)
                                                        </div>
                                                        <div className={"col-4  border"}>
                                                            <input type={"checkbox"}
