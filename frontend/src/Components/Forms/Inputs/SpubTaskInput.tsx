            ...
            <div className="table-striped w-100">
                <div className="text-white text-center" style={{"backgroundColor": "#052d73"}}>
                    <div className="d-flex flex-row center align-items-center">
                        ...
                        <div className="text-center d-none d-xl-block p-2" style={{width: "15%"}}>Rok rozpoczęcia</div>
                        <div className="text-center d-none d-xl-block p-2" style={{width: "15%"}}>Rok zakończenia</div>
