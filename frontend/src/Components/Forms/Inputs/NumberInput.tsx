                ...
                render={({ field }) => <input className={"text-center"} value={field.value}
                                              onBlur={(e)=>{
                                                  ...
                                                  if(props.connectedName && props.newVal) {
                                                      props.form!.setValue(props.connectedName, String(props.newVal(parseInt(e.target.value))), {shouldDirty: true})
                                                      props.form!.setValue(props.connectedName, String(props.newVal(parseInt(e.target.value))), {shouldValidate: true})}
                                                  else
                                                  {
                                                      field.onBlur()
                                                  }
