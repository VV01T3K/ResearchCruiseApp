...
const checkGroup = (group: [string, string[]], completedSections: (string|boolean)[][], setCompleted: {
    (value: SetStateAction<(string | boolean)[][]>): void;
    (arg0: any): void
}, dirtyFields: Partial<Readonly<{ [x: string]: any }>>, errors: FieldErrors<FieldValues>) => {
